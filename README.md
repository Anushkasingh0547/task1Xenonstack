README..... This repository contains several Bash scripts that perform various system management tasks. Below are descriptions and usage instructions for each script:
